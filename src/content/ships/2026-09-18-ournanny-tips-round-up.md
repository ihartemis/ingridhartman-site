...
- Every row in the billing ledger now opens a detail sheet instead of expanding in place or jumping to a delete prompt. A payment's sheet leads with what you paid ("$510.00 · incl. $10.00 tip"), then what went toward the balance, the tip, the note, and who recorded it, with delete at the bottom. A session's sheet shows the hours and rate breakdown and links to the session if the hours are wrong.
