...
- Every row in the billing ledger now opens a detail sheet instead of expanding in place or jumping to a delete prompt. A payment's sheet shows what went toward the balance with the tip beside it ("$500.00 + $10.00 tip", "$510.00 total"), the note, and who recorded it, with delete at the bottom. A session's sheet shows the hours and rate breakdown and links to the session if the hours are wrong.
